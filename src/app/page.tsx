...
import Icon, { useColorCycle } from "@/components/Icon";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <Text style={{ transition: 'color 2s ease' }} color={useColorCycle().currentColorKey} size="xl" inline>
    ...
    <form onSubmit={form.onSubmit((values) => onSubmit(values.url))}>
      <Flex direction="column" gap="md">
        ...
        <Button
          ...
          loading={loading}
          style={{ backgroundColor: isHovered ? '#b8b9bc' : '#c1c2c5', color: '#000000' }}
        ...
        <Flex align="center" justify="space-between" h="100%">
          <Flex direction="column">
            <Anchor
              size="sm"
              color="subtle"
              href="https://github.com/chrisdcosta777/kantar/issues"
              target="_blank"
            >
          ...
          <Flex gap={4}>
            <ActionIcon
              component="a"
              href="https://github.com/chrisdcosta777/kantar"
              target="_blank"
              size="lg"
              color="dark"
              title="GitHub"
