...
export function Player({
  ...
  useDocumentTitle(`${song.metadata.title} - Kantar`);
  ...
  useShallowEffect(() => {
    ...
    return () => {
      ...
      // change theme back to default - color check here
      setGlobalTheme({
        colorScheme: "dark",
        primaryColor: "blue",
        primaryShade: 5,
            ...
            <Menu shadow="md" width={200} position="top-end">
              ...
              <Menu.Dropdown>
                ...
                <Menu.Item
                  ...
                  component="a"
                  href="https://github.com/bgwastu/Kantar/issues"
                ...
                <Menu.Item
                  ...
                  component="a"
                  href={`https://x.com/intent/tweet?text=I'm listening to ${song.metadata.title} by ${song.metadata.author} on Kantar!&url=${window.location.href}
                  `}
                  rightSection={<IconExternalLink size={12} />}
                  target="_blank"
                >
